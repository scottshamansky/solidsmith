...
| "Will it print?" found out the hard way | `check` reports watertightness per body, bed fit, and whether the model actually sits on the plate |
...
```
✔ watertight (1 body)
✔ 80.0 × 50.0 × 30.0 mm on a 256 × 256 × 256 bed
